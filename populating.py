...
def main():
	...
	print(user_create(123456, "test@test", 'C:\\Users\\47238341840\\Downloads\\alemao.jpg'))
	headers_1 = create_headers(123456, "test@test")
	print(headers_1)
	print(create_natural_person(headers_1, 123456, 'Luís', '2004-06-19', '222222', 'Beck'))
 
	print(user_create(1234567, "test@test", 'C:/Users/47238341840/Downloads/alemao.jpg'))
	...
	print(user_create(654321, "test@test", 'C:/Users/47238341840/Downloads/alemao.jpg'))
	headers_3 = create_headers(654321, "test@test")
	print(create_legal_person(headers_3, 654321, 'Fantasy', '2023-06-19', '1234', '4321', 'Cars'))
 
	print(user_create(7654321, "test@test", 'C:/Users/47238341840/Downloads/alemao.jpg'))
